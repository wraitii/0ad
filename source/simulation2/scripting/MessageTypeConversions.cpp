...
JS::Value CMessageMovePaused::ToJSVal(ScriptInterface& scriptInterface) const
{
	TOJSVAL_SETUP();
	return JS::ObjectValue(*obj);
}

CMessage* CMessageMovePaused::FromJSVal(ScriptInterface& scriptInterface, JS::HandleValue val)
{
	FROMJSVAL_SETUP();
